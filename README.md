...
Works with:
 - Alfresco Enterprise 4.2.x, 5.0.x, 5.1.x, 5.2.x, 6.1.X, 6.2.x, 7.0.x, 7.1.X, 7.2.X, 7.3.X, 7.4.X, 23.1.X, 23.4.X, 25.1.X, 25.2.X, 25.3.X, 25.4.X
 - Alfresco Community 4.2.x, 5.0.x, 5.1.x, 5.2.x, 6.1.X, 6.2.x, 7.0.x, 7.1.X, 7.2.X, 7.3.X, 7.4.X, 23.1.X, 23.4.X, 25.1.X, 25.2.X, 25.3.X
...
- [Angel Thierry](https://github.com/ath-atolcd)
