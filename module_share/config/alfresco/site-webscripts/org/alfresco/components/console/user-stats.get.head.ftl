...
<@script type="text/javascript" src="${page.url.context}/res/components/console/user-stats.js"></@script>
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/components/console/user-stats.css" />
...
<@script type="text/javascript" src="${page.url.context}/res/components/console/open_flash_chart/get_user_data.js"></@script>
