...
public class SelectNodeTypesGet extends DeclarativeWebScript implements InitializingBean {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    Assert.notNull(this.namespaceService, "[Assertion failed] - this argument is required; it must not be null");
    Assert.notNull(this.dictionaryService, "[Assertion failed] - this argument is required; it must not be null");
  }
  ...
  public List<AuditNodeType> selectNodeType(AuditQueryParameters params, String query) {
    List<AuditNodeType> auditNodeTypeList = sqlSessionTemplate.selectList(query, params);
