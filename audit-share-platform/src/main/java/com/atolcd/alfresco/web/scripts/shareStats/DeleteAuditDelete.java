      ...
      if (this.sqlSessionTemplate != null) {
        ...
        if (auditQueryParameters != null) {
          if ("audit_entry".equals(purgeTable)) {
            deleteAuditEntries(auditQueryParameters.getDateFrom(), auditQueryParameters.getDateTo(), auditQueryParameters.getSiteId());
            model.put(MODEL_SUCCESS, true);

          } else if ("volumetry".equals(purgeTable)) {
            deleteVolumetryEntries(auditQueryParameters.getDateFrom(), auditQueryParameters.getDateTo(), auditQueryParameters.getSiteId());
            model.put(MODEL_SUCCESS, true);
